#!/usr/bin/env python3
"""Capture the complete Cromwell 92 SUCCESS behavior through generic V3."""
    ...
    *,
    ...
    with disposable_cromwell_fixture(
        ...
        result = v3.BehaviorHarvester().run(
            ...
            expected_engine=ENGINE_IDENTITY,
            run_id="cromwell_workflow_success_20260730",
        ...
        metadata = {
            ...
            "claims": {
                ...
                "native_failure": "provider_native_http_400_missing_source",
                "fixture": (
                    "disposable_loopback_cromwell_92_local_hsqldb_file"
                ),
                "resulting_state_relation": (
                    "observed_submitted_to_succeeded_changed"
                ),
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Capture one complete Cromwell 92 SUCCESS behavior program."
    )
