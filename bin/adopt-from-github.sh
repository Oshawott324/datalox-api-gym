...
HOST_REPO="${1:-}"
PACK_REPO_URL="${2:-https://github.com/Oshawott324/datalox-api-gym.git}"
CACHE_ROOT="${HOME}/.datalox/cache"
PACK_CACHE="${CACHE_ROOT}/datalox-api-gym"

if [ -z "$HOST_REPO" ]; then
  echo "Usage: bash bin/adopt-from-github.sh /path/to/host-repo [pack-repo-url]"
  echo "Default pack repo URL: https://github.com/Oshawott324/datalox-api-gym.git"
