...
function ensureRuntimeReady(runtimeRoot) {
  const serverEntrypoint = path.join(runtimeRoot, "dist", "src", "mcp", "trajectoryServer.js");
...
function resolveRuntimeEntrypoint(root) {
  ...
  throw new Error("Unable to resolve Datalox Trajectory MCP runtime root for datalox-mcp.js");
}
